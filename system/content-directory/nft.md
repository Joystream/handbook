...
This article will later be incorporated into the [Broken link](broken-reference "mention") document at a later time.
...
* **Type:** The [#auction-type](nft.md#auction-type "mention") representing what type of auction this is.
* **Minimal Bid Step:** The minimum difference in amount between two consecutive bids in order for the new bid to be valid.
* **Last Bid:** If present, is the last [#bid](nft.md#bid "mention")which was successfully submitted.
...
* **Owner:** The [#nft-owner](nft.md#nft-owner "mention")representing the current owner.
* **Status: The** [#transactional-status](nft.md#transactional-status "mention") representing the state of the NFT currently.
